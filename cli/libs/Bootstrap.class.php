...
use Configman\Cli\Commands\CommandAbstract;
...
class Bootstrap {
    ...
    public static function boot()
    {
        try {
             ...
             */
            foreach (new \DirectoryIterator(ROOT_PATH . '/cli/commands') as $item) {
                if (!$item->isDir()) {
                    $className = '\\Configman\\Cli\\Commands\\' . str_replace('.class.php', '', $item->getBaseName());
